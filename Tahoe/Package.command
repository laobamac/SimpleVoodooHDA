...
productbuild --distribution  ./Package/Distribution.xml --resources ./Package/Resources --package-path ./SimpleVoodooHDA.pkg ./Simple-VoodooHDA-Tahoe.pkg
rm -rf ./SimpleVoodooHDA.pkg
echo "完成"
pkgutil --expand ./Simple-VoodooHDA-Tahoe.pkg ./FileUse
Sleep 1
echo "= = = = = = = = = = = = = = = = = = = = = = = = =  "
echo "打包完成!   "
echo "= = = = = = = = = = = = = = = = = = = = = = = = =  "
...
Sleep 1
pkgutil --flatten ./FileUse ./Simple-VoodooHDA-Tahoe.pkg
Sleep 1
rm -rf ./FileUse
./package/FILES/seticon -d ./package/Pics/AppIcon.icns ./Simple-VoodooHDA-Tahoe.pkg
echo "= = = = = = = = = = = = = = = = = = = = = = = = =  "
echo "Simple-VoodooHDA-Tahoe.pkg
编译完成!   "
echo "= = = = = = = = = = = = = = = = = = = = = = = = =  "